...
// PA15 GSENSOR INT1
#define GSENSOR_INT1_PORT  								GPIOA
#define GSENSOR_INT1_PIN  	 							GPIO_PIN_15
/* Exported macro ------------------------------------------------------------*/
...
extern uint8_t GetLis3dhAlarmStatus(void);
extern uint8_t Lis3dhCheckWhoAmI(void);
extern void Lis3dhInitialize(void);
extern void Lis3dhDeinit(void);
extern void Lis3dhIntProcess(void);
